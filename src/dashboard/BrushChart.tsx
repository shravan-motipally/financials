...
export const background2 = '#7a4203';
...
// accessors
const getDate = (d: StockPrice) => d !== undefined ? new Date(d.date) : new Date();
const getStockValue = (d: StockPrice) => d.close;
...
function BrushChart({
  ...
  const [filteredStock, setFilteredStock] = useState<StockPrice[]>(stock);
